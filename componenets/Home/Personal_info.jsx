      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-full items-center">
        ...
        <div className="text-white flex flex-col justify-center items-center md:items-start text-center md:text-left order-2 md:order-1">
          <h1
            ...
            style={{
              fontSize: "clamp(24px, 5vw, 45px)", // Min size 24px, scales to max size 55px
            }}
          >
            Hi, I am
          </h1>
          ...
          <h3
            className="font-extrabold flex gap-3 text-center md:text-left text-nowrap"
            style={{
              fontSize: "clamp(20px, 4vw, 40px)", // Min size 20px, scales to max size 50px
            }}
          >
            I am
          ...
          <button className="rounded-xl bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 text-white w-full px-5 py-3 my-5" onClick={OpenResume}>
            Check Resume
          </button>
          ...
          <div className="flex items-center justify-center md:justify-start w-full py-2 mt-0 md:mt-5">
            ...
            }} className="text-center">{item.text}</p>
              </button>
              </Link>
