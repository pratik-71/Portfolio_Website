  ...
  const education = [
    {
      ...
      endyear: "2023",
      description:
        "I am currently pursuing a Bachelor's degree in Computer Science at Chhatrapati Shivaji Maharaj University, Panvel, where I am honing my skills in computer science and information technology.",
    },
    {
            ...
            >
              <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
                ...
                <div className="flex flex-col gap-1 text-white text-center md:text-left">
                  <p className="font-bold text-2xl md:text-xl">{edu.name}</p>
